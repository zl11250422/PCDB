...
from basicsr.archs.acb import ACBlock
from basicsr.archs.dbb_transforms import transI_fusebn
...
def build_model(arch):
    if arch == 'ResNet-18':
        ...
        model = BSRN(num_in_ch=3, num_feat=64, num_block=8, num_out_ch=3, upscale=4, conv='BSConvU')    
    else:
