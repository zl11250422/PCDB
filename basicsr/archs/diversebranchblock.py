...
class DiverseBranchBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if deploy:
            ...
            #self.dbb_1x1_kxk.add_module('conv1', nn.Conv2d(in_channels, in_channels, 1, bias=False))
            #self.dbb_1x1_kxk.add_module('norm', nn.BatchNorm2d(in_channels))
            #self.dbb_1x1_kxk.add_module('act', nn.ReLU())
            #self.dbb_1x1_kxk.add_module('conv2', nn.Conv2d(in_channels, in_channels, 1, bias=False))
            
            if internal_channels_1x1_3x3 == in_channels:
                self.dbb_1x1_kxk.add_module('idconv1', IdentityBasedConv1x1(channels=in_channels, groups=groups))
                #self.dbb_1x1_kxk.add_module('idconv1', nn.Conv2d(in_channels=in_channels, out_channels=internal_channels_1x1_3x3,
            ...
            #self.dbb_1x1_kxk.add_module('relu', nn.ReLU())
